...
label_title = Label(root, text="Question Categories", font=('Felix Titling', 30),bg='white')
label_title.place(x=540, y=140)

# Short Description

label_heading=Label(root,text='Click the drop down to select category',font=('Montserrat', 12),bg='white')
